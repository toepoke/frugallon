...
@Component({
	...
	directives: [Button, Content, Toolbar, Icon],
	styles: [`
		.toolbar {
	...
	template:`
		...
		<div class="toolbar" [hidden]="!showNavigation">
			<!-- lhs -->
			<div>
				<button type="submit" [hidden]="!showCancel()" (click)="onCancel()">
					Cancel
				</button>
			</div>
			...
			<!-- rhs -->
			<div>
				<button type="submit" [hidden]="!showBack()" (click)="goBack()">
					<ion-icon name="arrow-back"></ion-icon>
					Back
				</button>				

				<button light type="submit" [hidden]="!showSkip()" (click)="goSkip()">
					Skip
				</button>				
			
				<button [disabled]="!isStepValid()" type="submit" [hidden]="!showNext()" (click)="goNext()">
					Next
					<ion-icon name="arrow-forward"></ion-icon>
				</button>				

				<button secondary type="submit" [disabled]="!isStepValid()" [hidden]="!showFinish()" (click)="onFinish()">
					Finish
				</button>				
			</div>
...
export class Wizard {
	@ContentChildren(WizardStep) _steps: QueryList<WizardStep> = null;
